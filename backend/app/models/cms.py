...
class MediaAsset(Base, TimestampMixin):
    ...
    # Optimised image variants generated by
    # ``app.services.image_optimization.optimize_image`` at upload
    # time. Shape::
    #
    #     {
    #       "webp": {"thumb": "...-thumb.webp", "medium": "...", "large": "..."},
    #       "jpg":  {"thumb": "...-thumb.jpg",  "medium": "...", "large": "..."}
    #     }
    #
    # NULL means optimisation was skipped (SVG, video, broken file).
    # The frontend ``ResponsiveImage`` component falls back to the
    # original URL when this is NULL.
